  ...
  questions: Question[] = [
    {
        ...
        propositionsDetailed: ["Perceval", "Le Duc d'Acquitaine", "Monseigneur Boniface, êveque de Germanie", "La Reine Guenièvre"],
    ...
    },
    {
        ...
        propositionsDetailed: ["Arthur, roi de Bretagne", "Ketchatar, roi d'Irlande", "Loth, roi d'Orcanie", "Couillière, roi Burgonde"],
        propositionsShort: ["A", "B", "C", "D"],
        answer: "C",
    ...
    },
    {
        ...
        propositionsDetailed: ["Le chevalier au lion", "L'orphelin de Carmélide", "Le chevalier au pancréas", "Le chevalier de mes deux"],
        propositionsShort: ["A", "B", "C", "D"],
        answer: "C",
    ...
    },
    {
        ...
        propositionsDetailed: ["HAHA, Sire ! Je vous attends ! À moins que vous préfériez que l'on dise partout que le roi est une petite pédale qui pisse dans son froc à l'idée de se battre !", "En garde, espèce de vieille pute dégarnie !", "Mais allez-y bon sang, magnez-vous le fion, espèce de grosse dinde !", "En garde, ma biquette ! Je vais vous découper le gras du cul, ça vous fera ça de moins à trimbaler !"],
        propositionsShort: ["A", "B", "C", "D"],
        answer: "C",
    ...
    },
    {
        ...
        question: "Pour savoir s’il va y avoir du vent, il faut mettre son doigt dans le cul du coq",
    ...
    },
    {
        ...
        title: "Un destin exceptionnel",
        question: "Quel objet Perceval a rapporté au roi Arthur lorsqu'il est passé au travers d'un portail dimensionnel ?",
    ...
    },
    {
        ...
        title: "Un destin exceptionnel",
        question: "Quelle relique sacrée Perceval a balancé dans la forêt ou une rivière après l'avoir récupéré auprès d'un vieux clodo lors d'une de ces quêtes ?",
    ...
    },
    {
        ...
        title: "Sorts et Potions",
        question: "Quelle potion Merlin a créé par erreur pour Dame Mevanwi au lieu de préparer une potion pour le mal de gorge ?",
    ...
    },
    {
        ...
        title: "Sorts et Potions",
        question: "À l'instar de la pierre philosophale, que permet de transmuter la pierre de lune inventée par Merlin, et en quoi ?",
...

    {
        ...
        propositionsShort: ["A", "B", "C", "D"],
        answer: "C",
        answerComment: "Singapour a gagné son indépendance non pas parce qu'ils le voulait, mais parce que le parlement Malaysien a voté à l'unanimité (sans représentants de Singapour) l'expulsion de la Malaysie",
    ...
    },
    {
        ...
        question: "Qu'est-il arrivé lorsqu'un scientifique a voulu tester le paradoxe du singe savant ?",
        questionComment: "Ce paradoxe dit que si on laisse un singe devant une machine à écrire, au bout d'un moment il y a une chance que ce singe écrire une oeuvre de Shakespear",
        propositionsDetailed: ["Le singe a écrit 5 pages remplies de S", "Le singe a détruit le clavier avec une pierre", "Le singe a chié sur le clavier", "A, B, C et donc D"],
        propositionsShort: ["A", "B", "C", "D"],
        answer: "D",
    ...
    },
    {
        ...
        propositionsDetailed: ["Agathidium Vaderi en hommage à Darth Vador", "Agra Katewinsletae en hommage à Kate", "Agra Schwarzeneggeri en hommage à Schwarzenegger", "Anophthalmus Hitleri en hommage à Hitler"],
        propositionsShort: ["A", "B", "C", "D"],
        answer: "D",
    ...
    },
    {
        ...
        propositionsDetailed: ["1 page... Normal...", "16 pages... C'est un peu plus long...", "162 pages... Ça commence à faire beaucoup...", "0 page... On n'a pas encore réussi à le prouver... C'est un peu la honte..."],
        propositionsShort: ["A", "B", "C", "D"],
        answer: "C",
    ...
    },
    {
        ...
        propositionsDetailed: ["God willing, we shall return: Si Dieu le veut, nous reviendrons", "All right, let's get this mother out of here and go home: Très bien, sortons cette maman d'ici et rentrons chez nous", "Houston, we have a problem: Houston, nous avons un problème", "Chewie, we’re going home: Chewie, on renter à la maison"],
        propositionsShort: ["A", "B", "C", "D"],
        answer: "B",
    ...
    },
    {
        ...
        propositionsDetailed: ["Dark Age of Camelot", "World of Warcraft", "Guild Wars", "Bob l'éponge: Bataille pour Bikini Bottom"],
        propositionsShort: ["A", "B", "C", "D"],
        answer: "B",
    ...
    },
    {
        ...
        answerComment: "Like A Virgin est une chanson qui décrit l'état émotionnel de Steinberg après qu'une relation ratée l'a laissé dans les bras de quelqu'un d'autre. Cette nouvelle relation l'a fait se sentir brillant et nouveau. Vous savez, comme une vierge",
    ...
    },
    {
        ...
        propositionsShort: ["Ça parle de Cul", "Ça parle pas de Cul"],
        answer: "Ça parle pas de Cul",
        answerComment: "En fait Phil ne sait même pas de quoi ça parle vraiment, c'est juste cool",
    ...
    },
    {
        ...
        answerComment: "C'est à propos d'une femme qui trompe son copain avec deux de ses amis... En même temps... Si vous voyez ce que je veux dire...",
    ...
    },
    {
        ...
        title: "Parlons boules",
        question: "Quel pourcentage de son corps, les testicules de la decticelle côtière représentent ? (à 5% près)",
        answer: "14 %",
    ...
    },
    {
        ...
        title: "Parlons boules",
        question: "D’après les croyances du moyen-âge, quel testicule produirait des filles exclusivement ? Le testicule droit ou le gauche ?",
        answer: "Gauche",
        answerComment: "Comme tous ce qui est signe de malheur à l'époque. Certains se le faisait enlever parait-il...",
    ...
    },
    {
        ...
        title: "Parlons boules",
        question: "Chez les singes hurleurs, comment peut-on savoir qui a les plus petites boules ?",
    ...
    },
    {
        ...
        title: "GOAT",
        question: "Quelle est la BOAT (Boisson La plus bue of all time) ? (Après l’eau bien sûr)",
        answer: "Le Thé",
        answerComment: "Le Thé est la boisson la plus bue dans le monde après l’Eau. 500 millions de tasses de thés sont bues chaque jour.",
    ...
    },
    {
        ...
        answer: "La Bible",
        answerComment: "Patrick Sébastien, le vrai gout des tomates mûres. Juste devant la Bible. Non je déconne c’est la Bible.",
    ...
    },
    {
        ...
        answerComment: "Blinding Lights de The Weeknd suivi de près par Shape of You de Ed Sheeran (en date du 31 mars 2024). Bon j’ai un peu aidé en l’écoutant en boucle pendant 3 semaines",
    ...
    },
    {
        ...
        title: "GOAT",
        question: "Et enfin… Ah non merde. Un auteur a cru que c’était un menu sur les chèvres, du coup il y a une question qui n’a rien à voir… Je vous la pose quand même. Quel est le temps de gestation d’une chèvre ? (à 1 mois près)",
        answer: "5 mois",
    ...
    },
    {
        ...
        title: "Uniforme SS",
        question: "Question très simple pour se mettre en jambe, qui a designé et fabriqué les uniformes nazis ?",
    ...
    },
    {
        ...
        title: "Uniforme SS",
        question: "Qui a eu l’idée de la couleur noire des uniforme SS, pour se différencier des autres soldats ?",
    ...
    },
    {
        ...
        question: "C’est soit-disant un sport noble entre un animal et un homme, mais c’est pas mal surtout un massacre publique.",
    ...
    },
    {
        ...
        title: "La réponse est un titre de chanson",
        question: "C’est à propos d’une princesse Disney, mais c’est pas une chanson de Disney, et c’est pas une princesse, fin bref c’est aussi le nom d’une princesse Disney, c’est plus simple dit comme ça.",
