...
export class AdminStatsComponent implements OnInit {
  ...
  remontadaTable(): { name: string; rd1Rank: number; rd1Score: number; rd2Rank: number; rd2Score: number }[] {
    let teamsRd1 = new Map<string, number>()
    let teamsRd2 = new Map<string, number>()
    ...
    let finalTeams: { name: string; rd1Rank: number; rd1Score: number; rd2Rank: number; rd2Score: number }[] = []
